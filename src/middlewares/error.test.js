import { handleError } from '../../src/middleware/error.js'; // Asegúrate de que la ruta sea correcta
import { HttpError } from '../../src/types/http.error.js'; // Asegúrate de que la ruta sea correcta
