...
// Crear un mock del modelo UserModel
...
describe('UserRepo', () => {
  ...
  describe('query', () => {
    it('should return all users', async () => {
      ...
      UserModel.find.mockReturnValue({
        populate: jest.fn().mockReturnThis(), // Permite encadenar `populate`
        exec: jest.fn().mockResolvedValue(mockUsers), // Retorna los usuarios simulados
      });
  ...
  describe('queryById', () => {
    it('should return a user by id', async () => {
      ...
      UserModel.findById.mockReturnValue({
        ...
        exec: jest.fn().mockResolvedValue(mockUser), // Retorna el usuario simulado
      });
    ...
    it('should throw HttpError if user not found', async () => {
      UserModel.findById.mockReturnValue({
        populate: jest.fn().mockReturnThis(),
        exec: jest.fn().mockResolvedValue(null), // Simula que no se encontró el usuario
      });
  ...
  describe('create', () => {
    it('should create a new user', async () => {
      ...
      UserModel.create.mockResolvedValue(mockUser); // Retorna el nuevo usuario simulado
  ...
  describe('delete', () => {
    it('should delete a user by id', async () => {
      UserModel.findByIdAndDelete.mockReturnValue({
        exec: jest.fn().mockResolvedValue(true), // Simula que el usuario fue eliminado
      });
  ...
  describe('count', () => {
    it('should return the count of users', async () => {
      UserModel.countDocuments.mockReturnValue({
        exec: jest.fn().mockResolvedValue(5), // Simula que hay 5 usuarios
      });
